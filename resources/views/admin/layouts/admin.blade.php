...
<head>
    ...
    <title>@yield('title', 'TripWise — Admin Panel')</title>
    ...
    <script src="https://cdn.jsdelivr.net/npm/chart.js" defer></script>    <style>
        :root {
            --primary: #F44336;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .chart-card h3 i { font-size: 0.9rem; opacity: 0.7; }
        ...
        .table-card h3 i { font-size: 0.9rem; opacity: 0.7; }
        ...
        .section-card h3 i { font-size: 0.9rem; opacity: 0.7; }
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="nav-menu">
        ...
        <a href="javascript:void(0);" class="nav-parent {{ request()->routeIs('admin.learning.*') ? 'open' : '' }}" data-target="nav-learning" onclick="event.preventDefault(); toggleAccordion(this)">
            <i class="fas fa-book-open"></i>
            <span class="nav-text">Learning Management</span>
            <i class="fas fa-chevron-right chevron"></i>
        </a>
        <div class="nav-submenu {{ request()->routeIs('admin.learning.*') ? 'open' : '' }}" id="nav-learning">
            <a href="{{ route('admin.learning.modules') }}" class="nav-subitem {{ request()->routeIs('admin.learning.modules') ? 'active' : '' }}">Learning Modules</a>
        ...
        <a href="javascript:void(0);" class="nav-parent {{ request()->routeIs('admin.training.*') ? 'open' : '' }}" data-target="nav-training" onclick="event.preventDefault(); toggleAccordion(this)">
            <i class="fas fa-chalkboard-teacher"></i>
            <span class="nav-text">Training Management</span>
            <i class="fas fa-chevron-right chevron"></i>
        </a>
        <div class="nav-submenu {{ request()->routeIs('admin.training.*') ? 'open' : '' }}" id="nav-training">
            <a href="{{ route('admin.training.schedule') }}" class="nav-subitem {{ request()->routeIs('admin.training.schedule') ? 'active' : '' }}">Training Schedule</a>
        ...
        <div class="nav-submenu {{ request()->routeIs('admin.succession.*') ? 'open' : '' }}" id="nav-succession">
            <a href="{{ route('admin.succession.leadership') }}" class="nav-subitem {{ request()->routeIs('admin.succession.leadership') ? 'active' : '' }}">Leadership Potential</a>
            <a href="{{ route('admin.succession.career-path') }}" class="nav-subitem {{ request()->routeIs('admin.succession.career-path') ? 'active' : '' }}">Career Path</a>
            <a href="{{ route('admin.succession.development-plan') }}" class="nav-subitem {{ request()->routeIs('admin.succession.development-plan') ? 'active' : '' }}">Development Plan</a>
            <a href="{{ route('admin.succession.promotion-readiness') }}" class="nav-subitem {{ request()->routeIs('admin.succession.promotion-readiness') ? 'active' : '' }}">Promotion Readiness</a>
            <a href="{{ route('admin.succession.succession-history') }}" class="nav-subitem {{ request()->routeIs('admin.succession.succession-history') ? 'active' : '' }}">Succession History</a>
        ...
        <div class="nav-submenu {{ request()->routeIs('admin.evaluation.*') ? 'open' : '' }}" id="nav-evaluation">
            <a href="{{ route('admin.evaluation.driver-evaluation') }}" class="nav-subitem {{ request()->routeIs('admin.evaluation.driver-evaluation') ? 'active' : '' }}">Driver Evaluation</a>
        ...
        <div class="nav-submenu {{ request()->routeIs('admin.reports.*') || request()->routeIs('*.analytics') ? 'open' : '' }}" id="nav-reports">
            <a href="{{ route('admin.reports.analytics-dashboard') }}" class="nav-subitem {{ request()->routeIs('admin.reports.analytics-dashboard') || request()->routeIs('*.analytics') ? 'active' : '' }}">📊 System Analytics Dashboard</a>
        ...
        <div class="nav-submenu {{ request()->routeIs('admin.notifications.*') ? 'open' : '' }}" id="nav-notifications">
            <a href="{{ route('admin.notifications.training') }}" class="nav-subitem {{ request()->routeIs('admin.notifications.training') ? 'active' : '' }}">Training Notifications</a>
            <a href="{{ route('admin.notifications.performance') }}" class="nav-subitem {{ request()->routeIs('admin.notifications.performance') ? 'active' : '' }}">Performance Notifications</a>
            <a href="{{ route('admin.notifications.announcements') }}" class="nav-subitem {{ request()->routeIs('admin.notifications.announcements') ? 'active' : '' }}">System Announcements</a>
            <a href="{{ route('admin.notifications.history') }}" class="nav-subitem {{ request()->routeIs('admin.notifications.history') ? 'active' : '' }}">Notification History</a>
            <a href="{{ route('admin.notifications.settings') }}" class="nav-subitem {{ request()->routeIs('admin.notifications.settings') ? 'active' : '' }}">Notification Settings</a>
            <a href="{{ route('admin.notifications.logs') }}" class="nav-subitem {{ request()->routeIs('admin.notifications.logs') ? 'active' : '' }}">Notification Logs</a>
        </div>

        <a href="javascript:void(0);" class="nav-parent {{ request()->routeIs('admin.users.*') ? 'open' : '' }}" data-target="nav-users" onclick="event.preventDefault(); toggleAccordion(this)">
            <i class="fas fa-user-cog"></i>
            <span class="nav-text">User Management</span>
            <i class="fas fa-chevron-right chevron"></i>
        </a>
        <div class="nav-submenu {{ request()->routeIs('admin.users.*') ? 'open' : '' }}" id="nav-users">
            <a href="{{ route('admin.users.accounts') }}" class="nav-subitem {{ request()->routeIs('admin.users.accounts') ? 'active' : '' }}">User Accounts</a>
            <a href="{{ route('admin.users.roles') }}" class="nav-subitem {{ request()->routeIs('admin.users.roles') ? 'active' : '' }}">User Roles & Permissions</a>
            <a href="{{ route('admin.users.account-management') }}" class="nav-subitem {{ request()->routeIs('admin.users.account-management') ? 'active' : '' }}">Account Management</a>
            <a href="{{ route('admin.users.login-logs') }}" class="nav-subitem {{ request()->routeIs('admin.users.login-logs') ? 'active' : '' }}">Login & Activity Logs</a>
            <a href="{{ route('admin.users.security') }}" class="nav-subitem {{ request()->routeIs('admin.users.security') ? 'active' : '' }}">Security Monitoring</a>
            <a href="{{ route('admin.users.audit-logs') }}" class="nav-subitem {{ request()->routeIs('admin.users.audit-logs') ? 'active' : '' }}">Audit Logs</a>
        </div>

        <a href="javascript:void(0);" class="nav-parent {{ request()->routeIs('admin.settings.*') ? 'open' : '' }}" data-target="nav-settings" onclick="event.preventDefault(); toggleAccordion(this)">
            <i class="fas fa-cog"></i>
            <span class="nav-text">Settings</span>
            <i class="fas fa-chevron-right chevron"></i>
        </a>
        <div class="nav-submenu {{ request()->routeIs('admin.settings.*') ? 'open' : '' }}" id="nav-settings">
            <a href="{{ route('admin.settings.agency.index') }}" class="nav-subitem {{ request()->routeIs('admin.settings.agency.*') ? 'active' : '' }}">Agency Settings</a>
            <a href="{{ route('admin.settings.preferences.index') }}" class="nav-subitem {{ request()->routeIs('admin.settings.preferences.*') ? 'active' : '' }}">System Preferences</a>
            <a href="{{ route('admin.settings.security.index') }}" class="nav-subitem {{ request()->routeIs('admin.settings.security.*') ? 'active' : '' }}">Security Settings</a>
            <a href="{{ route('admin.settings.appearance.index') }}" class="nav-subitem {{ request()->routeIs('admin.settings.appearance.*') ? 'active' : '' }}">Appearance & Localization</a>
            <a href="{{ route('admin.settings.backup.index') }}" class="nav-subitem {{ request()->routeIs('admin.settings.backup.*') ? 'active' : '' }}">Backup & Recovery</a>
            <a href="{{ route('admin.settings.logs.index') }}" class="nav-subitem {{ request()->routeIs('admin.settings.logs.*') ? 'active' : '' }}">System Logs</a>
        </div>
