...
@section('title', 'TripWise — Learning Reports')
...
<div class="table-card" style="margin-bottom:1rem;">
    <form method="GET" action="{{ route('admin.learning.reports') }}" style="display:flex;gap:1rem;align-items:flex-end;flex-wrap:wrap;">
