<?php $__env->startSection('title', 'TripWise — Manage Drivers'); ?>
...
<div class="summary-grid">
    <div class="summary-card">
        ...
        <div class="card-info">
            <h3><?php echo e($totalDrivers ?? 0); ?></h3>
            <p>Total Drivers</p>
        </div>
    </div>
    <div class="summary-card">
        ...
        <div class="card-info">
            <h3><?php echo e($activeDrivers ?? 0); ?></h3>
            <p>Active Drivers</p>
        </div>
    </div>
    <div class="summary-card">
        ...
        <div class="card-info">
            <h3><?php echo e($underReviewDrivers ?? 0); ?></h3>
    ...
    <div class="summary-card">
        ...
        <div class="card-info">
            <h3><?php echo e(number_format($avgPerformance ?? 4.6, 1)); ?>/5</h3>
...
<div class="table-card" style="margin-bottom: 1.5rem;">
    <form action="<?php echo e(route('admin.drivers.index')); ?>" method="GET" class="filter-bar" style="margin-bottom: 0;">
        <div class="search-box" style="flex: 1; min-width: 250px;">
            <i class="fas fa-search"></i>
            <input type="text" name="search" id="searchDriver" value="<?php echo e(request('search')); ?>" placeholder="Search Driver Name, Driver ID, Contact Number..." style="width: 100%;">
        </div>
        <select name="status" id="filterStatus">
            <option value="">All Status</option>
            <option value="active" <?php echo e(request('status') == 'active' ? 'selected' : ''); ?>>Active</option>
            <option value="inactive" <?php echo e(request('status') == 'inactive' ? 'selected' : ''); ?>>Inactive</option>
            <option value="review" <?php echo e(request('status') == 'review' ? 'selected' : ''); ?>>Under Review</option>
        ...
        <select name="branch" id="filterBranch">
            ...
            <option value="North Branch" <?php echo e(request('branch') == 'North Branch' ? 'selected' : ''); ?>>North Branch</option>
            <option value="South Branch" <?php echo e(request('branch') == 'South Branch' ? 'selected' : ''); ?>>South Branch</option>
            <option value="East Branch" <?php echo e(request('branch') == 'East Branch' ? 'selected' : ''); ?>>East Branch</option>
            <option value="West Branch" <?php echo e(request('branch') == 'West Branch' ? 'selected' : ''); ?>>West Branch</option>
            <option value="Central Branch" <?php echo e(request('branch') == 'Central Branch' ? 'selected' : ''); ?>>Central Branch</option>
        </select>
        <select name="vehicle_type" id="filterVehicle">
            ...
            <option value="Van" <?php echo e(request('vehicle_type') == 'Van' ? 'selected' : ''); ?>>Van</option>
            <option value="Motorcycle" <?php echo e(request('vehicle_type') == 'Motorcycle' ? 'selected' : ''); ?>>Motorcycle</option>
        </select>
        ...
        <a href="<?php echo e(route('admin.drivers.index')); ?>" class="btn btn-secondary"><i class="fas fa-undo"></i> Reset</a>
        <a href="<?php echo e(route('admin.drivers.export')); ?>" class="btn btn-secondary"><i class="fas fa-file-export"></i> Export</a>
    </form>
</div>
...
<div class="table-card">
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="<?php echo e(route('admin.drivers.profile', $driver->id)); ?>" title="View <?php echo e($driver->first_name); ?>'s profile">
                            <img src="<?php echo e($driver->photo ?: asset('drivers/photo/' . $driver->id)); ?>" alt="<?php echo e($driver->first_name); ?>" style="width:40px;height:40px;border-radius:50%;object-fit:cover;cursor:pointer;">
                        </a>
                    </td>
                    <td><a href="<?php echo e(route('admin.drivers.profile', $driver->id)); ?>" style="color:inherit;text-decoration:none;"><strong><?php echo e($driver->formatted_id); ?></strong></a></td>
                    <td><a href="<?php echo e(route('admin.drivers.profile', $driver->id)); ?>" style="color:inherit;text-decoration:none;"><strong><?php echo e($driver->full_name); ?></strong></a></td>
                    <td><?php echo e($driver->contact_number); ?></td>
                    <td><?php echo e($driver->vehicle_assignment ?? 'Unassigned'); ?></td>
                    <td><?php echo e($driver->vehicle_type ?? 'N/A'); ?></td>
                    <td><?php echo e($driver->route_assignment ?? 'N/A'); ?></td>
                    <td><?php echo e($driver->branch ?? 'N/A'); ?></td>
                    <td>
                        <?php if($driver->status === 'active'): ?>
                            <span class="status-badge status-active">Active</span>
                        <?php elseif($driver->status === 'review'): ?>
                        ...
                        <?php else: ?>
                            <span class="status-badge status-pending"><?php echo e(ucfirst($driver->status)); ?></span>
                        <?php endif; ?>
                    </td>
                    <td>
                        <div style="display:flex;align-items:center;gap:0.5rem;">
                            <i class="fas fa-star" style="color:#f59e0b;font-size:0.85rem;"></i>
                            <span><?php echo e(number_format($driver->performance_score, 1)); ?></span>
                        </div>
                    </td>
                    <td>
                        <a href="<?php echo e(route('admin.drivers.profile', $driver->id)); ?>" class="icon-btn" title="View Documents">
                            <i class="fas fa-file-alt"></i>
                        </a>
                    </td>
                    <td style="text-align:center;">
                        <div style="display:flex;gap:0.4rem;justify-content:center;flex-wrap:wrap;">
                            <a href="<?php echo e(route('admin.drivers.profile', $driver->id)); ?>" class="icon-btn" title="View Profile">
                                <i class="fas fa-eye"></i>
                            </a>
                            <button class="icon-btn" title="Edit Driver" onclick="editDriver(<?php echo e(json_encode($driver)); ?>)">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button class="icon-btn" title="Activate/Deactivate" onclick="openStatusModal(<?php echo e($driver->id); ?>, '<?php echo e(ucfirst($driver->status)); ?>')">
                                <i class="fas fa-power-off"></i>
                            </button>
                            <button class="icon-btn" title="Archive Driver" onclick="openArchiveModal(<?php echo e($driver->id); ?>)">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-top:1.5rem;padding-top:1rem;border-top:1px solid var(--border);">
        <div style="font-size:0.85rem;color:var(--text-muted);">
            Showing <?php echo e($drivers->firstItem() ?? 0); ?> to <?php echo e($drivers->lastItem() ?? 0); ?> of <?php echo e($drivers->total()); ?> drivers
        </div>
        <div>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Herd\TEAM-3\resources\views/admin/drivers.blade.php ENDPATH**/ ?>