<?php $__env->startSection('title', 'TripWise — Learning Analytics'); ?>
...
<div class="summary-grid">
    ...
    <div class="summary-card">
        ...
        <div class="card-info">
            <h3><?php echo e($stats['avg_quiz_score']); ?></h3>
    ...
    <div class="summary-card">
        ...
        <div class="card-info">
            <h3><?php echo e($stats['learning_progress']); ?></h3>
    ...
    <div class="summary-card">
        ...
        <div class="card-info">
            <h3><?php echo e($stats['module_effectiveness']); ?></h3>
...
<div class="table-card" style="margin-bottom:1rem;">
    <form method="GET" action="<?php echo e(route('admin.learning.analytics')); ?>" style="display:flex;gap:1rem;align-items:flex-end;flex-wrap:wrap;">
        ...
        <div style="min-width:180px;">
            ...
            <select name="module" style="width:100%;padding:0.6rem 1rem;border:1px solid var(--border);border-radius:0.5rem;font-size:0.9rem;background:var(--white);color:var(--text-dark);font-family:'Inter',sans-serif;">
                ...
                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($module->id); ?>" <?php echo e(request('module') == $module->id ? 'selected' : ''); ?>><?php echo e($module->title); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div style="min-width:180px;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(document.getElementById('learningProgressAnalyticsChart'), {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($progressAnalytics->pluck('module.title')->toArray()); ?>,
            datasets: [{
                label: 'Completion %',
                data: <?php echo json_encode($progressAnalytics->pluck('avg_progress')->toArray()); ?>,
    ...
    new Chart(document.getElementById('moduleDistChart'), {
        type: 'pie',
        data: {
            labels: <?php echo json_encode($moduleDist->pluck('module.title')->toArray()); ?>,
            datasets: [{ data: <?php echo json_encode($moduleDist->pluck('total')->toArray()); ?>, backgroundColor: ['#10b981', '#3b82f6', '#f59e0b', '#6366f1', '#8b5cf6'] }]
        },
    ...
    new Chart(document.getElementById('learningEffectivenessChart'), {
        type: 'line',
        data: {
            labels: <?php echo json_encode($effectiveness->pluck('month_num')->toArray()); ?>,
            datasets: [{
                label: 'Effectiveness %',
                data: <?php echo json_encode($effectiveness->pluck('avg_progress')->toArray()); ?>,
                borderColor: '#3b82f6',
    ...
    new Chart(document.getElementById('learningComparativeChart'), {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($comparative->keys()->map(fn($id) => $drivers->firstWhere('id', $id)?->name ?? 'Driver')->toArray()); ?>,
            datasets: [
                { label: 'Completion %', data: <?php echo json_encode($comparative->pluck('completion')->toArray()); ?>, backgroundColor: '#F44336', borderRadius: 8 },
                { label: 'Quiz Score', data: <?php echo json_encode($comparative->pluck('quiz')->toArray()); ?>, backgroundColor: '#3b82f6', borderRadius: 8 }
            ]
        },
        options: { ...chartDefaults, scales: { y: { beginAtZero: true, max: 100 } } }
    });
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Herd\TEAM-3\resources\views/admin/learning/learning-analytics.blade.php ENDPATH**/ ?>