<?php $__env->startSection('title', 'TripWise — Learning Modules by Position'); ?>
...
<div style="display:grid;grid-template-columns:repeat(auto-fill, minmax(260px, 1fr));gap:1.25rem;" id="positionsGrid">
    <?php $__currentLoopData = $positionsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="position-card" data-name="<?php echo e(strtolower($pos['name'])); ?>" data-category="<?php echo e($pos['category_type']); ?>" style="background:var(--white);border:1px solid var(--border);border-radius:1rem;overflow:hidden;box-shadow:0 4px 14px rgba(0,0,0,0.04);transition:transform 0.25s ease, box-shadow 0.25s ease;display:flex;flex-direction:column;justify-content:space-between;">
            <div>
                ...
                <div style="position:relative;height:190px;background:#FAF6EE;overflow:hidden;display:flex;align-items:center;justify-content:center;">
                    <img src="<?php echo e($pos['img']); ?>" alt="<?php echo e($pos['name']); ?>" style="width:100%;height:100%;object-fit:cover;">
                    ...
                    <div style="position:absolute;left:1rem;bottom:0.75rem;width:40px;height:40px;border-radius:50%;background:var(--charcoal);color:var(--white);display:flex;align-items:center;justify-content:center;box-shadow:0 4px 10px rgba(0,0,0,0.15);z-index:2;">
                        <i class="<?php echo e($pos['icon']); ?>" style="font-size:1.05rem;"></i>
                    </div>
                </div>

                <!-- Card Body -->
                <div style="padding:1.25rem 1.25rem 0.75rem;">
                    <h3 style="font-size:0.95rem;font-weight:700;color:var(--text-dark);margin:0 0 0.25rem;letter-spacing:0.02em;"><?php echo e($pos['name']); ?></h3>
                    <p style="font-size:0.8rem;color:var(--text-muted);margin:0 0 1rem;"><?php echo e($pos['count']); ?> Modules</p>

                    <!-- Progress Bar -->
                    <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:1rem;">
                        <div style="flex:1;height:6px;background:var(--border);border-radius:3px;overflow:hidden;">
                            <div style="width:<?php echo e($pos['completion']); ?>%;height:100%;background:var(--primary);border-radius:3px;"></div>
                        </div>
                        <span style="font-size:0.75rem;font-weight:600;color:var(--text-muted);"><?php echo e($pos['completion']); ?>% Complete</span>
                    </div>
                </div>
            </div>
            ...
            <div style="padding:0 1.25rem 1.25rem;">
                <a href="<?php echo e(route('admin.learning.modules', ['position' => $pos['name']])); ?>" style="display:block;width:100%;padding:0.6rem 0;text-align:center;border:1px solid var(--border);border-radius:0.5rem;background:var(--white);color:var(--text-dark);font-size:0.85rem;font-weight:600;text-decoration:none;transition:all 0.2s ease;">
                    View Modules
                </a>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Herd\TEAM-3\resources\views/admin/learning/learning-modules.blade.php ENDPATH**/ ?>