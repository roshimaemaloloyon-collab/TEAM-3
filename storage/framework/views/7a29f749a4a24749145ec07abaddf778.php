<?php $__env->startSection('title', 'TripWise — Leadership Potential'); ?>
    ...
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><strong>#DRV-2026-<?php echo e(sprintf('%04d', $c['driver']->id ?? 1)); ?></strong></td>
                    <td><strong><?php echo e($c['driver']->full_name ?? 'Driver'); ?></strong></td>
                    <td><strong><?php echo e($c['performance_score']); ?>/5</strong></td>
                    <td><?php echo e($c['competency_score']); ?>% Average</td>
                    <td><?php echo e($c['recommended_role']); ?></td>
                    <td><span class="status-badge <?php echo e($c['readiness'] === 'High Potential' ? 'badge-success' : 'status-pending'); ?>"><?php echo e($c['readiness']); ?></span></td>
                    <td><span class="status-badge status-active">Active</span></td>
                    <td style="text-align: center;">
                        <div style="display: flex; gap: 0.4rem; justify-content: center;">
                            <button class="icon-btn" title="View" onclick="showToast('View leadership assessment for <?php echo e($c['driver']->full_name); ?>')"><i class="fas fa-eye"></i></button>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Herd\TEAM-3\resources\views/admin/succession/leadership.blade.php ENDPATH**/ ?>