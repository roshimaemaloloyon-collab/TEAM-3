<?php $__env->startSection('title', 'TripWise — Driver Profile'); ?>
...
<div class="page-header">
    ...
    <div style="display:flex;gap:0.75rem;">
        <a href="<?php echo e(route('admin.drivers.index')); ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to Drivers</a>
...
<div class="table-card" style="margin-bottom:1.5rem;">
    <div style="display:flex;align-items:center;gap:1.5rem;flex-wrap:wrap;">
        <img src="<?php echo e($driver->photo ?: asset('drivers/photo/' . ($driver->id ?? 1))); ?>" alt="<?php echo e($driver->full_name); ?>" style="width:90px;height:90px;border-radius:50%;object-fit:cover;border:3px solid var(--primary);">
        <div style="flex:1;min-width:200px;">
            <h2 style="font-size:1.5rem;color:var(--primary);margin:0 0 0.25rem;"><?php echo e($driver->full_name); ?></h2>
            <p style="font-size:0.9rem;color:var(--text-muted);margin:0 0 0.5rem;"><?php echo e($driver->formatted_id); ?> • <?php echo e($driver->branch ?? 'North Branch'); ?> • <?php echo e($driver->route_assignment ?? 'North Route'); ?> • <?php echo e($driver->vehicle_assignment ?? 'Unassigned'); ?></p>
            <div style="display:flex;gap:0.5rem;flex-wrap:wrap;">
                <span class="status-badge status-<?php echo e(strtolower($driver->status ?? 'active')); ?>"><?php echo e(ucfirst($driver->status ?? 'Active')); ?></span>
                <span class="status-badge" style="background:#d1fae5;color:#065f46;"><?php echo e(number_format($driver->performance_score ?? 4.9, 1)); ?> Performance</span>
                <span class="status-badge" style="background:#dbeafe;color:#1e40af;"><?php echo e(number_format($driver->trips_count ?? 1248)); ?> Trips</span>
            </div>
        </div>
    </div>
</div>
...
<div class="tab-content-wrapper">
        ...
        <div class="section-grid">
            <div class="section-card">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-top:1rem;">
                    <div><label style="font-size:0.8rem;color:var(--text-muted);">Full Name</label><p style="font-weight:600;"><?php echo e($driver->full_name); ?></p></div>
                    <div><label style="font-size:0.8rem;color:var(--text-muted);">Driver ID</label><p style="font-weight:600;"><?php echo e($driver->formatted_id); ?></p></div>
                    <div><label style="font-size:0.8rem;color:var(--text-muted);">Contact</label><p style="font-weight:600;"><?php echo e($driver->contact_number ?? 'N/A'); ?></p></div>
                    <div><label style="font-size:0.8rem;color:var(--text-muted);">Email</label><p style="font-weight:600;"><?php echo e($driver->email ?? 'N/A'); ?></p></div>
                    <div><label style="font-size:0.8rem;color:var(--text-muted);">Branch</label><p style="font-weight:600;"><?php echo e($driver->branch ?? 'N/A'); ?></p></div>
                    <div><label style="font-size:0.8rem;color:var(--text-muted);">Route</label><p style="font-weight:600;"><?php echo e($driver->route_assignment ?? 'N/A'); ?></p></div>
                    <div><label style="font-size:0.8rem;color:var(--text-muted);">Vehicle</label><p style="font-weight:600;"><?php echo e($driver->vehicle_assignment ?? 'N/A'); ?></p></div>
                    <div><label style="font-size:0.8rem;color:var(--text-muted);">Status</label><p><span class="status-badge status-<?php echo e(strtolower($driver->status ?? 'active')); ?>"><?php echo e(ucfirst($driver->status ?? 'Active')); ?></span></p></div>
                </div>
            </div>
            <div class="section-card">
                <h3><i class="fas fa-chart-bar"></i> Performance Snapshot</h3>
                <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1rem;margin-top:1rem;">
                    <div style="background:var(--beige);padding:1rem;border-radius:0.75rem;text-align:center;"><p style="font-size:1.5rem;font-weight:700;color:var(--primary);margin:0;"><?php echo e(number_format($driver->performance_score ?? 4.9, 1)); ?></p><p style="font-size:0.8rem;color:var(--text-muted);">Performance</p></div>
                    <div style="background:var(--beige);padding:1rem;border-radius:0.75rem;text-align:center;"><p style="font-size:1.5rem;font-weight:700;color:var(--primary);margin:0;"><?php echo e(number_format($driver->trips_count ?? 1248)); ?></p><p style="font-size:0.8rem;color:var(--text-muted);">Trips</p></div>
                    <div style="background:var(--beige);padding:1rem;border-radius:0.75rem;text-align:center;"><p style="font-size:1.5rem;font-weight:700;color:var(--primary);margin:0;"><?php echo e($driver->complaints_count ?? 0); ?></p><p style="font-size:0.8rem;color:var(--text-muted);">Complaints</p></div>
                </div>
            </div>
        </div>
    ...
    <div id="tab-personal" class="profile-page-tab" style="display:none;">
        <div class="section-card">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-top:1rem;">
                <div><label style="font-size:0.8rem;color:var(--text-muted);">First Name</label><p style="font-weight:600;"><?php echo e($driver->first_name); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Middle Name</label><p style="font-weight:600;"><?php echo e($driver->middle_name ?? 'N/A'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Last Name</label><p style="font-weight:600;"><?php echo e($driver->last_name); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Birth Date</label><p style="font-weight:600;"><?php echo e($driver->birth_date ? \Carbon\Carbon::parse($driver->birth_date)->format('M d, Y') : 'N/A'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Gender</label><p style="font-weight:600;"><?php echo e($driver->gender ?? 'Male'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Civil Status</label><p style="font-weight:600;"><?php echo e($driver->civil_status ?? 'Single'); ?></p></div>
                <div style="grid-column:span 2;"><label style="font-size:0.8rem;color:var(--text-muted);">Address</label><p style="font-weight:600;"><?php echo e($driver->address ?? 'N/A'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Contact Number</label><p style="font-weight:600;"><?php echo e($driver->contact_number ?? 'N/A'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Email Address</label><p style="font-weight:600;"><?php echo e($driver->email ?? 'N/A'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Emergency Contact Person</label><p style="font-weight:600;"><?php echo e($driver->emergency_contact_person ?? 'N/A'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Emergency Contact Number</label><p style="font-weight:600;"><?php echo e($driver->emergency_contact_number ?? 'N/A'); ?></p></div>
            </div>
        </div>
    </div>
    ...
    <div id="tab-employment" class="profile-page-tab" style="display:none;">
        <div class="section-card">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-top:1rem;">
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Driver ID</label><p style="font-weight:600;"><?php echo e($driver->formatted_id); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Date Hired</label><p style="font-weight:600;"><?php echo e($driver->date_hired ? \Carbon\Carbon::parse($driver->date_hired)->format('M d, Y') : 'N/A'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Branch</label><p style="font-weight:600;"><?php echo e($driver->branch ?? 'N/A'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Vehicle Assignment</label><p style="font-weight:600;"><?php echo e($driver->vehicle_assignment ?? 'Unassigned'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Vehicle Type</label><p style="font-weight:600;"><?php echo e($driver->vehicle_type ?? 'N/A'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Route Assignment</label><p style="font-weight:600;"><?php echo e($driver->route_assignment ?? 'N/A'); ?></p></div>
                <div style="grid-column:span 2;"><label style="font-size:0.8rem;color:var(--text-muted);">Employment Status</label><p><span class="status-badge status-<?php echo e(strtolower($driver->status ?? 'active')); ?>"><?php echo e(ucfirst($driver->status ?? 'Active')); ?></span></p></div>
            </div>
        </div>
    </div>
    ...
    <div id="tab-documents" class="profile-page-tab" style="display:none;">
        <div class="section-card">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.5rem;flex-wrap:wrap;gap:0.75rem;">
                <h3 style="margin:0;"><i class="fas fa-file-alt"></i> Driver Documents (<?php echo e($driver->full_name); ?>)</h3>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Admin User</td>
                            <td><?php echo e($driver->updated_at ? $driver->updated_at->format('M d, Y') : 'Jan 10, 2026'); ?></td>
                        ...
                        <tr>
                            <td><strong><i class="fas fa-file-alt" style="color:var(--primary);margin-right:0.5rem;"></i>OR/CR (<?php echo e($driver->vehicle_assignment ?? 'Vehicle'); ?>)</strong></td>
                            <td>Jan 10, 2026</td>
                            <td>Jun 20, 2027</td>
                            <td><span class="status-badge" style="background:#d1fae5;color:#065f46;">🟢 Verified</span></td>
                            <td>Admin User</td>
    ...
    <div id="tab-vehicle" class="profile-page-tab" style="display:none;">
        <div class="section-card">
            <h3><i class="fas fa-car"></i> Vehicle Information (<?php echo e($driver->full_name); ?>)</h3>
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-top:1rem;">
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Vehicle ID</label><p style="font-weight:600;">VH-2026-<?php echo e(str_pad($driver->id, 3, '0', STR_PAD_LEFT)); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Plate Number</label><p style="font-weight:600;"><?php echo e(strtoupper(substr($driver->last_name ?? 'ABC', 0, 3))); ?>-<?php echo e(1000 + $driver->id); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Vehicle Type</label><p style="font-weight:600;"><?php echo e($driver->vehicle_type ?? 'N/A'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Vehicle Model / Name</label><p style="font-weight:600;"><?php echo e($driver->vehicle_assignment ?? 'Unassigned'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Assigned Branch</label><p style="font-weight:600;"><?php echo e($driver->branch ?? 'N/A'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Assigned Route</label><p style="font-weight:600;"><?php echo e($driver->route_assignment ?? 'N/A'); ?></p></div>
    ...
    <div id="tab-license" class="profile-page-tab" style="display:none;">
        <div class="section-card">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-top:1rem;">
                <div><label style="font-size:0.8rem;color:var(--text-muted);">License Number</label><p style="font-weight:600;"><?php echo e($driver->license_number ?? 'N01-12-345678'); ?></p></div>
                ...
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Date Hired</label><p style="font-weight:600;"><?php echo e($driver->date_hired ? \Carbon\Carbon::parse($driver->date_hired)->format('M d, Y') : 'Jan 15, 2021'); ?></p></div>
                <div><label style="font-size:0.8rem;color:var(--text-muted);">Expiration Date</label><p style="font-weight:600;"><?php echo e($driver->license_expiration ? \Carbon\Carbon::parse($driver->license_expiration)->format('M d, Y') : 'Mar 15, 2027'); ?></p></div>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Herd\TEAM-3\resources\views/admin/driver-profile.blade.php ENDPATH**/ ?>