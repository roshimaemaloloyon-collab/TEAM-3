<?php $__env->startSection('title', 'TripWise — Performance Reports'); ?>
...
<div class="summary-grid">
    ...
    <div class="summary-card">
        ...
        <div class="card-info">
            <h3><?php echo e($stats['individual']); ?></h3>
    ...
    <div class="summary-card">
        ...
        <div class="card-info">
            <h3><?php echo e($stats['ranking']); ?></h3>
            <p>Ranking Reports</p>
        </div>
    </div>
    <div class="summary-card">
...
<div class="table-card" style="margin-bottom:1rem;">
    <form method="GET" action="<?php echo e(route('admin.performance.reports')); ?>" style="display:flex;gap:1rem;align-items:flex-end;flex-wrap:wrap;">
        ...
        <div style="min-width:180px;">
            ...
            <select name="type" style="width:100%;padding:0.6rem 1rem;border:1px solid var(--border);border-radius:0.5rem;font-size:0.9rem;background:var(--white);color:var(--text-dark);font-family:'Inter',sans-serif;">
                ...
                <option value="ranking" <?php echo e(request('type') === 'ranking' ? 'selected' : ''); ?>>Ranking</option>
                <option value="kpi" <?php echo e(request('type') === 'kpi' ? 'selected' : ''); ?>>KPI</option>
                <option value="safety" <?php echo e(request('type') === 'safety' ? 'selected' : ''); ?>>Safety</option>
                <option value="attendance" <?php echo e(request('type') === 'attendance' ? 'selected' : ''); ?>>Attendance</option>
            </select>
        </div>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Herd\TEAM-3\resources\views/admin/performance/performance-reports.blade.php ENDPATH**/ ?>