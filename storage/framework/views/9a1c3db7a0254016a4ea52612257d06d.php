<?php $__env->startSection('title', 'TripWise — Training Evaluation'); ?>
...
<div class="summary-grid">
    ...
    <div class="summary-card">
        ...
        <div class="card-info">
            <h3><?php echo e($stats['satisfaction']); ?></h3>
...
<div class="table-card" style="margin-bottom:1rem;">
    <form method="GET" action="<?php echo e(route('admin.training.evaluations')); ?>" style="display:flex;gap:1rem;align-items:flex-end;flex-wrap:wrap;">
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $evaluations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><strong><?php echo e($evaluation->training->title ?? 'N/A'); ?></strong></td>
                        <td><?php echo e($evaluation->driver->name ?? 'N/A'); ?></td>
                        <td><strong><?php echo e($evaluation->overall_rating ?? 'N/A'); ?>/5</strong></td>
                        <td><?php echo e(Str::limit($evaluation->driver_feedback, 50)); ?></td>
                        <td><?php echo e(Str::limit($evaluation->recommendations, 50)); ?></td>
                        <td><?php echo e($evaluation->created_at->format('M d, Y')); ?></td>
                        <td>
                            <span class="item-badge <?php echo e($evaluation->status === 'completed' ? 'badge-success' : 'badge-warning'); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(document.getElementById('evaluationTrendChart'), {
        type: 'line',
        data: {
            labels: <?php echo json_encode($evaluationTrend->pluck('month_num')->toArray()); ?>,
            datasets: [{
                label: 'Avg Score',
                data: <?php echo json_encode($evaluationTrend->pluck('avg_rating')->toArray()); ?>,
                borderColor: '#F44336',
    ...
    new Chart(document.getElementById('satisfactionChart'), {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($satisfactionByCategory->pluck('category')->toArray()); ?>,
            datasets: [{
                label: 'Satisfaction %',
                data: <?php echo json_encode($satisfactionByCategory->pluck('avg_rating')->toArray()); ?>,
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Herd\TEAM-3\resources\views/admin/training/evaluation.blade.php ENDPATH**/ ?>