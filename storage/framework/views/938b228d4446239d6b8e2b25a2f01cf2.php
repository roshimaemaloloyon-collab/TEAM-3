<?php $__env->startSection('title', 'TripWise — Admin Dashboard'); ?>
...
<div class="glance-bar">
    <a href="<?php echo e(route('admin.drivers.index')); ?>" class="glance-item">
        <i class="fas fa-car" style="color:#3b82f6;"></i>
        <span>Total: <strong><?php echo e($totalDrivers ?? 95); ?></strong></span>
    </a>
    <div class="glance-divider"></div>
    <a href="<?php echo e(route('admin.drivers.index', ['status' => 'active'])); ?>" class="glance-item">
        <i class="fas fa-check-circle" style="color:#10b981;"></i>
        <span>Active: <strong><?php echo e($activeDrivers ?? 37); ?></strong></span>
    </a>
    <div class="glance-divider"></div>
    <a href="<?php echo e(route('admin.drivers.index', ['status' => 'inactive'])); ?>" class="glance-item">
        <i class="fas fa-times-circle" style="color:#f59e0b;"></i>
        <span>Inactive: <strong><?php echo e($inactiveDrivers ?? 24); ?></strong></span>
    </a>
    <div class="glance-divider"></div>
    <a href="<?php echo e(route('admin.drivers.index', ['status' => 'under_review'])); ?>" class="glance-item">
        <i class="fas fa-clock" style="color:#8b5cf6;"></i>
        <span>Review: <strong><?php echo e($driversUnderReview ?? 0); ?></strong></span>
    </a>
    <div class="glance-divider"></div>
    <a href="<?php echo e(route('admin.evaluation.review')); ?>" class="glance-item">
        <i class="fas fa-clipboard-list" style="color:#ec4899;"></i>
        <span>Pending Peer: <strong><?php echo e($totalPendingPeerEvaluations ?? 17); ?></strong></span>
    </a>
    <div class="glance-divider"></div>
    <a href="<?php echo e(route('admin.training.schedule')); ?>" class="glance-item">
        <i class="fas fa-calendar-alt" style="color:#10b981;"></i>
        <span>Trainings: <strong><?php echo e($upcomingTrainings ?? 8); ?></strong></span>
    </a>
    <div class="glance-divider"></div>
    <div class="glance-item">
        <i class="fas fa-star" style="color:#f59e0b;"></i>
        <span>Agency Score: <strong style="color:var(--primary);"><?php echo e($avgPerformanceScore ?? '2.52'); ?>/5</strong></span>
    </div>
    <div class="glance-divider"></div>
    <div class="glance-item">
        <i class="fas fa-graduation-cap" style="color:#3b82f6;"></i>
        <span>Learning: <strong style="color:#10b981;"><?php echo e($learningCompletionRate ?? '100.0'); ?>%</strong></span>
    </div>
    
    <a href="<?php echo e(route('admin.drivers.index')); ?>" class="btn btn-primary" style="padding: 0.35rem 0.75rem; font-size: 0.75rem; border-radius: 0.5rem;">
    ...
    <div style="display:flex; flex-direction:column; gap:1.25rem;">
        ...
        <div class="minimal-card">
            <div class="minimal-card-header">
                ...
                <a href="<?php echo e(route('admin.performance.reports')); ?>" style="font-size:0.75rem; color:var(--primary); text-decoration:none; font-weight:600;">View All &rarr;</a>
            </div>
            <table class="compact-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $topPerformers ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $perf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <tr>
                        <td>
                            <div style="display:flex; align-items:center; gap:0.4rem;">
                                <span style="width:20px; height:20px; border-radius:50%; background:<?php echo e($index === 0 ? '#10b981' : '#3b82f6'); ?>; color:#fff; display:inline-flex; align-items:center; justify-content:center; font-size:0.65rem; font-weight:bold;"><?php echo e(substr($initials, 0, 2) ?: 'DR'); ?></span>
                                <strong><?php echo e($driverName); ?></strong>
                            </div>
                        </td>
                        <td><strong style="color:var(--primary);"><?php echo e(number_format($perf['performance_score'] ?? 4.5, 2)); ?>/5</strong></td>
                        <td><?php echo e($perf['competency_score'] ?? '88.5'); ?>%</td>
        ...
        <div class="minimal-card">
            <div class="minimal-card-header">
                ...
                <a href="<?php echo e(route('admin.performance.kpi')); ?>" style="font-size:0.75rem; color:var(--primary); text-decoration:none; font-weight:600;">Monitor &rarr;</a>
            </div>
            
            <div class="kpi-row">
                <div class="kpi-row-header">
                    <span><i class="fas fa-shield-alt" style="color:#10b981; font-size:0.7rem;"></i> Safety Score</span>
                    <span style="color:#10b981;"><?php echo e($kpiStats['safety_score'] ?? '94.5%'); ?></span>
                </div>
                <div class="thin-progress-bg"><div class="thin-progress-fill" style="width:<?php echo e((float)str_replace('%','',$kpiStats['safety_score'] ?? '94.5')); ?>%; background:#10b981;"></div></div>
            </div>

            <div class="kpi-row">
                <div class="kpi-row-header">
                    <span><i class="fas fa-user-check" style="color:#10b981; font-size:0.7rem;"></i> Attendance Rate</span>
                    <span style="color:#10b981;"><?php echo e($kpiStats['attendance_rate'] ?? '89.2%'); ?></span>
                </div>
                <div class="thin-progress-bg"><div class="thin-progress-fill" style="width:<?php echo e((float)str_replace('%','',$kpiStats['attendance_rate'] ?? '89.2')); ?>%; background:#10b981;"></div></div>
            </div>

            <div class="kpi-row">
                <div class="kpi-row-header">
                    <span><i class="fas fa-route" style="color:#f59e0b; font-size:0.7rem;"></i> Trip Completion Rate</span>
                    <span style="color:#f59e0b;"><?php echo e($kpiStats['trip_completion_rate'] ?? '76.4%'); ?></span>
                </div>
                <div class="thin-progress-bg"><div class="thin-progress-fill" style="width:<?php echo e((float)str_replace('%','',$kpiStats['trip_completion_rate'] ?? '76.4')); ?>%; background:#f59e0b;"></div></div>
            </div>

            <div class="kpi-row">
                <div class="kpi-row-header">
                    <span><i class="fas fa-star" style="color:#ef4444; font-size:0.7rem;"></i> Customer Rating</span>
                    <span style="color:#ef4444;"><?php echo e($kpiStats['customer_rating'] ?? '46.9%'); ?></span>
                </div>
                <div class="thin-progress-bg"><div class="thin-progress-fill" style="width:<?php echo e((float)str_replace('%','',$kpiStats['customer_rating'] ?? '46.9')); ?>%; background:#ef4444;"></div></div>
            </div>
        </div>
    ...
    <div style="display:flex; flex-direction:column; gap:1.25rem;">
        ...
        <div class="minimal-card">
            <div class="minimal-card-header">
                ...
                <a href="<?php echo e(route('admin.training.schedule')); ?>" style="font-size:0.75rem; color:var(--primary); text-decoration:none; font-weight:600;">Schedule &rarr;</a>
            </div>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:0.5rem; margin-bottom:0.85rem; text-align:center;">
                <div style="background:#f8fafc; border:1px solid #e2e8f0; padding:0.5rem; border-radius:0.5rem;">
                    ...
                    <div style="font-size:1.1rem; font-weight:bold; color:#3b82f6;"><?php echo e($upcomingTrainings ?? 8); ?></div>
                </div>
                <div style="background:#f8fafc; border:1px solid #e2e8f0; padding:0.5rem; border-radius:0.5rem;">
                    <div style="font-size:0.65rem; color:var(--text-muted);">Ongoing</div>
                    <div style="font-size:1.1rem; font-weight:bold; color:#f59e0b;"><?php echo e($ongoingTrainings ?? 8); ?></div>
                </div>
                <div style="background:#f8fafc; border:1px solid #e2e8f0; padding:0.5rem; border-radius:0.5rem;">
                    <div style="font-size:0.65rem; color:var(--text-muted);">Completed</div>
                    <div style="font-size:1.1rem; font-weight:bold; color:#10b981;"><?php echo e($completedTrainings ?? 14); ?></div>
                </div>
            </div>
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; background:#ecfdf5; border:1px solid #a7f3d0; padding:0.6rem 0.75rem; border-radius:0.5rem; font-size:0.75rem;">
                ...
                <span style="font-size:0.9rem; font-weight:bold; color:#047857;"><?php echo e($learningCompletionRate ?? '100.0'); ?>%</span>
            </div>
        </div>
        ...
        <div class="minimal-card">
            <div class="minimal-card-header">
                ...
                <a href="<?php echo e(route('admin.recognition.awards')); ?>" style="font-size:0.75rem; color:var(--primary); text-decoration:none; font-weight:600;">Awards &rarr;</a>
            </div>
...
<div class="bottom-row">
    ...
    <div class="minimal-card">
        <div class="minimal-card-header">
            ...
            <a href="<?php echo e(route('admin.notifications.history')); ?>" style="font-size:0.75rem; color:var(--primary); text-decoration:none; font-weight:600;">History &rarr;</a>
        </div>
        <div style="display:flex; flex-direction:column; gap:0.4rem; font-size:0.75rem;">
    ...
    <div class="minimal-card">
        <div class="minimal-card-header">
            ...
            <a href="<?php echo e(route('admin.succession.talent-pool')); ?>" style="font-size:0.75rem; color:var(--primary); text-decoration:none; font-weight:600;">Pool &rarr;</a>
        </div>
    ...
    <div class="minimal-card" style="display:flex; flex-direction:column; justify-content:space-between;">
        <div class="minimal-card-header" style="margin-bottom:0.4rem; border-bottom:none;">
            ...
            <a href="<?php echo e(route('admin.performance.drivers')); ?>" style="color:var(--primary);"><i class="fas fa-chevron-right" style="font-size:0.75rem;"></i></a>
        </div>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Herd\TEAM-3\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>