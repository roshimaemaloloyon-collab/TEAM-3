<?php $__env->startSection('title', 'TripWise — Assessments'); ?>
...
<div class="table-card" style="margin-bottom:1rem;">
    <form method="GET" action="<?php echo e(route('admin.learning.assessments')); ?>" style="display:flex;gap:1rem;align-items:flex-end;flex-wrap:wrap;">
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $assessments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assessment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td>#ASM-<?php echo e(str_pad($assessment->id, 5, '0', STR_PAD_LEFT)); ?></td>
                        <td><strong><?php echo e($assessment->driver->name ?? 'N/A'); ?></strong></td>
                        <td><?php echo e($assessment->module->title ?? 'N/A'); ?></td>
                        <td><strong><?php echo e($assessment->score ?? 'N/A'); ?></strong></td>
                        <td><?php echo e($assessment->passing_score); ?></td>
                        <td><?php echo e($assessment->attempt); ?> / <?php echo e($assessment->max_attempts); ?></td>
                        <td>
                            <span class="item-badge <?php echo e($assessment->status === 'passed' ? 'badge-success' : ($assessment->status === 'failed' ? 'badge-danger' : 'badge-warning')); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(document.getElementById('quizPerformanceChart'), {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($quizPerformance->pluck('module.title')->toArray()); ?>,
            datasets: [{
                label: 'Average Score',
                data: <?php echo json_encode($quizPerformance->pluck('avg_score')->toArray()); ?>,
    ...
    new Chart(document.getElementById('passFailChart'), {
        type: 'doughnut',
        data: {
            labels: <?php echo json_encode(array_keys($passFailData)); ?>,
            datasets: [{ data: <?php echo json_encode(array_values($passFailData)); ?>, backgroundColor: ['#10b981', '#ef4444'] }]
        },
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Herd\TEAM-3\resources\views/admin/learning/assessments.blade.php ENDPATH**/ ?>