...
Route::middleware(['web', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/drivers/vehicles/assign', [App\Http\Controllers\DriverController::class, 'assignVehicle'])->name('drivers.vehicles.assign');
    ...
    Route::prefix('succession')->name('succession.')->group(function () {
        ...
        Route::get('/development-plan/export', [SuccessionController::class, 'exportDevelopmentPlan'])->name('development-plan.export');
        Route::delete('/development-plan/{id}', [SuccessionController::class, 'destroyDevelopmentPlan'])->name('development-plan.destroy');
